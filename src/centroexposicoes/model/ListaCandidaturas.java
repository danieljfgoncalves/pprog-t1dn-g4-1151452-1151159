...
public class ListaCandidaturas implements Serializable {
    ...
    /**
     * Constrói uma instância de lista de candidaturas recebendo uma lista de
     * candidaturas.
     *
    ...
    /**
     * Constrói uma instância de lista de candidaturas copiando uma lista de
     * candidaturas.
     *
     * @param listaCandidaturas lista de candidaturas
     */
    ...
    /**
     * Remove uma candidatura à lista de candidaturas, validando ao detalhe.
     *
     * @param candidatura Candidatura a ser removida
     * @return True se for removida com sucesso
     */
    ...
    /**
     * Remove uma candidatura à lista de candidaturas.
     *
     * @param candidatura Candidatura a ser removida
     * @return True se for removida com sucesso
     */
